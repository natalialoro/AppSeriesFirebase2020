package com.example.appseriesfirebase2020.adapters;
...
public class SerieAdapter extends BaseAdapter {
    ...
    public SerieAdapter(Context context, ArrayList<SerieModel> list) {
    ...
    @Override
    public SerieModel getItem(int i) {
        return list.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view == null){
            ...
            view = layoutInflater.inflate(R.layout.serie_item, viewGroup, false);
        }
